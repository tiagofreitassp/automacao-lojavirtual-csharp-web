...
###  - Massas
*Descricao: Antes de executar va na classe MyStoreTest/MyStoreTest.cs e verifique se a massa que ja esta la esta 
funcionando no site, pois o adm do MyStore apaga os emails criados depois de 90 dias.
...
caso voce perceba que o metodo que cria o documento do Word ou PDF estiverem ausente, e por causa do problema nao ter sido resolvido, mas a criacao da pasta e insercao das imagens estao sem problemas). 
